    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Patient'), ('medecin', 'Médecin'), ('pharmacie', 'Pharmacie'), ('admin', 'Administrateur')], default='patient', max_length=20, verbose_name='Rôle')),
